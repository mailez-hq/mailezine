...
var supportedRequires = map[string]struct{}{
	...
	// mailez extensions (the mailez default script template depends on
	// these; implementations live in mailez.go).
	"index":        {},
	"editheader":   {},
	"vacation":     {},
	"spamtestplus": {},
...
func init() {
	...
	commands = map[string]func(*Script, parser.Cmd) (Cmd, error){
		...
		"reject":  loadReject,
		"ereject": loadEReject,
		// mailez extensions (editheader/vacation)
	...
	tests = map[string]func(*Script, parser.Test) (Test, error){
		...
		"body": loadBodyTest,
		// mailez extensions (spamtestplus/date/mailbox)
